...
//   GET /api/matches?riotId=&offset=0&limit=20&queue=0&champion=0 -> матчи
//                        игрока из хранилища, новые первыми, все десять
//                        участников; champion — только игры на этом чемпионе.
//   GET /api/players?q=амп&limit=8 -> подсказки ника: игроки из сохранённых
//                        матчей, чей Riot ID содержит q (без учёта регистра).
...
//                        501 у всех пяти — нет ключа или хранилища.
