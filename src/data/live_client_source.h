...
public:
    ...
    // Два запроса: /liveclientdata/gamestats и /liveclientdata/playerlist.
    // Любой из них не удался или не разобрался — nullopt целиком:
    // табло без времени матча и время без табло одинаково бесполезны.
